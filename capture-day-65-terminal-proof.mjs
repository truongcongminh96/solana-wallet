...
const outputFile = new URL("./day-65-terminal-proof.png", import.meta.url);
const proofFile = new URL("./day-65-terminal-proof.txt", import.meta.url);
...
await page.setContent(
  ...
  <html lang="en">
    <head>
      <meta charset="utf-8" />
      <title>Day 65 Terminal Proof</title>
      <style>
    ...
    <body>
      <div class="frame">
        <div class="bar">
          ...
          <span class="title">day-65 per-user PDA counter proof</span>
        </div>
        <pre></pre>
      </div>
    </body>
